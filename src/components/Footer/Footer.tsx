      ...
      <div className="relative z-20 grid grid-cols-1 items-start gap-20 md:grid-cols-2 md:gap-12">
        <div>
          ...
          <p className="text-tertiary-content">
            I specialize in building end-to-end analytics solutions that empower websites and applications with meaningful insights.
          </p>
          <a
            href="#"
